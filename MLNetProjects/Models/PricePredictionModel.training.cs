    ...
    public partial class PricePredictionModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"CPU", @"CPU"),new InputOutputColumnPair(@"GPU", @"GPU"),new InputOutputColumnPair(@"RAMType", @"RAMType"),new InputOutputColumnPair(@"SSD", @"SSD")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=6,NumberOfLeaves=4,FeatureFraction=0.7813199F,LabelColumnName=@"Price",FeatureColumnName=@"Features"}));
