...
namespace PricePredictionModelConsole
{
    public partial class PricePredictionModel
    {
        public const string RetrainFilePath =  @"E:\projetosErick\MLNetProjects\MLNetProjects\Data\laptoppricesUS.tsv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"CPU", @"CPU"),new InputOutputColumnPair(@"GPU", @"GPU"),new InputOutputColumnPair(@"RAMType", @"RAMType"),new InputOutputColumnPair(@"SSD", @"SSD")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=27,NumberOfLeaves=4,FeatureFraction=1F,LabelColumnName=@"Price",FeatureColumnName=@"Features"}));
